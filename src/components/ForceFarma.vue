                ...
                <div class="single__wrapper">
                    <div class="slider__wrapper">
                        <div id="sync1" class="thumbnails owl-carousel owl-theme">
                            <div class="item">
                                <img src="../img/force-farma_new.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma1.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma2.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma3.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma4.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma5.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma6.png">
                            </div>
                            <div class="item">
                                <img src="../img/single/force-farma7.png">
                            </div>
                        </div>
